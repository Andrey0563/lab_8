...
to=[]
while True:
 n,p=int(input('Введіть кількість рядків1:  ')),int(input('Введіть кількість стовбців1: '))#вводим размерность матрицы 1
 v,x=int(input('Введіть кількість рядків2:  ')),int(input('Введіть кількість стовбців2: '))#вводим размерность матрицы 2
 while n !=3 and p !=3:
